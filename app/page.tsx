...
export default function Home() {
  return (
    <ClinicShell active="ראשי">
      ...
      <section className="clinic-home-shortcuts" aria-label="פעולות מהירות">
        <button type="button" className="clinic-home-shortcut">
          <span>01</span>
          <div><strong>יומן טיפולים</strong><small>לראות ולנהל את היום והשבוע</small></div>
        </button>
        <Link href="/patients" className="clinic-home-shortcut">
          <span>02</span>
          <div><strong>המטופלים שלי</strong><small>כרטיסים, טיפולים ומעקב אישי</small></div>
        </Link>
        <Link href="/study" className="clinic-home-shortcut">
          <span>03</span>
          <div><strong>ספריית ידע</strong><small>חומרי הלימוד נשארים זמינים</small></div>
        </Link>
      </section>
    </ClinicShell>
  );
