...
const COOKIE="lihi_streak_game_herbs_points_v1";
export type StreakState={score:number;lives:number;startedAt:number;questionId:string|null;used:string[];lastSubject?:string|null;optionOrder?:string[];lastCorrectSlot?:number|null};
